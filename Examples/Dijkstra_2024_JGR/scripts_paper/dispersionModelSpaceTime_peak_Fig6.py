...
plt.plot(((tforcing_matrix/Tadj_matrix)).flatten(),((Tdelay1/Tadj_matrix)).flatten(), '.', label=r'$t<\frac{1}{2}T$', markersize=0.5)
plt.plot(((tforcing_matrix/Tadj_matrix)).flatten(),((Tdelay2/Tadj_matrix)).flatten(), '.', label=r'$t>\frac{1}{2}T$', markersize=0.5)
plt.plot(((tforcing_matrix/Tadj_matrix)[:,int(len(t)/2)]).flatten(),((Tdelay/Tadj_matrix)[:,int(len(t)/2)]).flatten(), 'o', color='k', label=r'$t=\frac{1}{2}T$')
