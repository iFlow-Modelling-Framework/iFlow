...
Kh0 = 100
ssea0 = 30
amp_vec = [250,500,1000,250,500,1000,250,500,1000]
...
for q, P in enumerate(Pvec):
    ...
    if q<3:
        plt.subplot(3,2,1)
        plt.yticks([800,1300,1800])

    elif q<6:
        plt.subplot(3,2,3)
        plt.yticks([400,900,1400])
    else:
        plt.subplot(3,2,5)
        plt.yticks([100,600,1100])
    ...
    plt.plot(((tforcing_matrix/Tadj_matrix)).flatten(),((Tdelay/Tadj_matrix)).flatten(), '.', color=p[0].get_color(), markersize=0.3)
