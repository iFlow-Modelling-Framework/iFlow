...
class HinderedSettling_bed:
    ...
    def run(self):
        ...
        d['__derivative']['x'] = {}
        d['__derivative']['xx'] = {}
        d['__derivative']['x']['ws0'] = ny.savitzky_golay(ny.derivative(ws, 'x', self.input), 7, 1)
        d['__derivative']['xx']['ws0'] = ny.savitzky_golay(ny.secondDerivative(ws, 'x', self.input), 7, 1)
